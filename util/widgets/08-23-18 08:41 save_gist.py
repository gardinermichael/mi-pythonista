# coding: utf-8
#! python2
# Aug 23, 2018 at 8:03 AM
# page title: Adds Python gists to Pythonista.
# url: https://gist.github.com/philgruneich/a48b50e46f01dc7ac96d
# https://onetapless.com/blog/add-scripts-to-pythonista-from-gists
# 
# 
# coding: utf-8
...
save_path = '/private/var/mobile/Library/Mobile Documents/iCloud~com~omz-software~Pythonista3/Documents/downloads/gists/'
...
def download_gist(gist_url):
	...
	raw_match = re.match('http(s?)://raw.github.com/gist/', str(gist_url))
	if raw_match:
		import requests
		...
		gist_id_match = re.match('http(s?)://gist.github.com/([0-9a-zA-Z]*)/([0-9a-f]*)', str(gist_url))
		if gist_id_match:
			import requests
