...
# url: https://forum.omz-software.com/topic/3576/beginner-help-on-tableview-in-ui-module/4
...
class MyClass(ui.View):
    ...
    def finished(self, sender):
        ...
        if not self.table1_selection:
            result = console.alert('please select from table 1 first', hide_cancel_button=False)
